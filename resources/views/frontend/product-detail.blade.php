                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" required class="form-control" id="title" aria-describedby="titlelHelp"
                                        name="title" style="background-color: #F1F3F4">
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="card text-center mt-2 border-0">
                            <div class="card-body">
                                ...
                                <img class="img-thumbnail rounded float-start" src="{{ Auth::user()->image }}"
                                            ...
                                            <form method="POST" action="{{ route('review.update', $r->id) }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="editDes" rows="3"
                                                        name="descripcion" required>{{ $r->descripcion }}</textarea>
                                                </div>
                        ...
                        @else
                        <p class="text-muted text-center">No se encontraron valoraciones para este producto, se el
