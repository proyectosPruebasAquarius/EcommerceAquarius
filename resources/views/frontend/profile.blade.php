                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="card-body">
                            ...
                            &nbsp;
                            <a type="button" href="{{ url('/restore/contraseña') }}" class="btn btn-outline-primary"><i class="lni lni-lock-alt"></i> Cambiar contraseña</a>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item mx-auto g-0" role="presentation">
                                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><i class="fas fa-truck"></i> Direcciones de envío</button>
                                </li>
                                <li class="nav-item mx-auto g-0" role="presentation">
                                    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="fab fa-wpforms"></i> Direcciones de facturión</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <form method="post" action="{{ route('update.direccion', $direccion->id) }}" class="form-horizontal" id="formDirecciones{{ $loop->index }}">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="card-subtitle mb-2 text-muted">
                                                            ...
                                                            <div class="mb-3 row">
                                                                <label for="staticReferencia{{ $loop->index }}" class="col-sm-2 col-form-label">Punto de referencia envío</label>
                                                                <div class="col-sm-10">
                                    ...
                                    @if ($loop->last)
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6 mx-auto">
                                                <button type="button"class="btn btn-outline-dark shadow-lg" onclick="addElement('direccion')"><i class="fal fa-plus-octagon"></i> Agregar nueva dirección de envío</button>
                                            </div>
                                        </div>
                                    @endif
                                    @empty
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                            ...
                                            <div class="card mt-2 mb-2">
                                                <form method="post" action="{{ route('delete.direccion.facturacion', $fct->id) }}" class="form-horizontal" id="formFacturaciones{{ $loop->index }}">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <input type="submit" onclick="return confirm('¿Estas seguro que deseas eliminar esta dirección de facturación?')" class="card-link btn text-danger" value="Eliminar"></input>
                                                    </div>
                                                    <div class="row d-none" id="hiddenRow">
                                                        <div class="col-6-col-md-4 mb-1">
                                                            <a type="button" class="card-link btn" onclick="setReadOnly('{{ $loop->index }}')">Cancelar</a>
                                    ...
                                    @if ($loop->last)
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6 mx-auto">
                                                <button type="button"class="btn btn-outline-dark shadow-lg" onclick="addElement('facturacion')"><i class="fal fa-plus-octagon"></i> Agregar nueva dirección de facturación</button>
                                            </div>
                                        </div>
                                    @endif
                                    @empty
