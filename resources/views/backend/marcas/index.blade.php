        ...
        <section class="section mx-3">
            <div class="card">
                <div class="col-12 d-flex justify-content-end mt-3">
                    ...
                    <a href="/admin/marcas/add" class="btn btn-primary mx-4"><i class="far fa-plus"></i>&nbsp;Nueva</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped text-center table-bordered pt-3 pb-3" id="marcaTable">
