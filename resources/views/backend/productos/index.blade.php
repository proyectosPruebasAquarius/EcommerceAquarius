            ...
            <div class="card-body">
                <table class="table table-striped  text-center pt-3 pb-3" id="prodTable">
                    ...
                    <tbody >
                        ...
                        <tr>
                            <td>{{$p->nombre}}</td>
                            <td><i class="fas fa-align-justify" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$p->descripcion}}"></i></td>
                            <td>{{$p->marca}}</td>
                            <td>{{$p->categoria}}</td>
                            <td>
                                {{$p->proveedor}}
                            ...
                            <td>
                               <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#imagesModal{{ $producto }}">
                                   Ver Imagenes del producto
                                </button>
                                
                                <!-- Modal -->
                                <div class="modal fade" id="imagesModal{{ $producto }}" tabindex="-1" aria-labelledby="imagesModalLabel{{ $producto }}" aria-hidden="true" style="padding-top: 8%">
                                    <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header ">
                                        <h5 class="modal-title text-center col-11"  id="imagesModalLabel{{ $producto }}">Imagenes del producto</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div id="carouselExampleControls{{ $producto }}" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                                <div class="carousel-inner">
                                                    ...
                                                    <div class="carousel-item">
                                                      <img src="{{ $value }}" class="d-block img-fluid" alt="Producct Image">
                                                    </div>   
                                                    @endif
                                                ...
                                                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls{{ $producto }}" data-bs-slide="prev">
                                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                    <span class="visually-hidden">Siguiente</span>
                                                  </button>
                                                  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls{{ $producto }}" data-bs-slide="next">
                            ...
                            <td>
                                <ul class="list-inline m-0">
                                    ...
                                    <li class="list-inline-item" data-toggle="tooltip" data-placement="top" title="Editar">
                                        <a href="productos/edit/{{$parameter}}" class="btn btn-success btn-sm rounded-0" type="button"><i class="fal fa-pencil-alt"></i></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <form action="{{url('admin/productos/delete/')}}/{{$parameter}}" method="post" id="formDel">
                                            @method('DELETE')
                                            @csrf
