            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p>Estos productos estan de ofertas, no pierdas la oportunidad de encontrar el productos que necesitas para tu automovil.</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p>Estos son los ultimos productos ingresados, no pierdas la oportunidad de encontrar el producto que necesitas para tu automovil.</p>
                    </div>
                </div>
            </div>
            <div class="row">
