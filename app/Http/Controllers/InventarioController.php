...
class InventarioController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('inventarios.id','precio_compra','stock','precio_venta','codigo','productos.nombre as producto','inventarios.min_stock','inventarios.estado','ofertas.nombre as oferta')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        $id_decrypt = Crypt::decrypt($id);
       Inventario::where('inventarios.id','=',$id_decrypt)->update([
